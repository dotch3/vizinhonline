        ...
        <div class="row ">
            ...
            <div class="col-md-8 container">
                <section class="div_feed_items col-md-10">
                            ...
                            <form method="post" action="{{ route('posts.update',$post) }}" enctype="multipart/form-data"
                                ...
                                <div class="container">
                                    ...
                                    <div class="detalhe_post col-md-12">
                                        <a href="">
                                            <img src="{{asset('/storage/posts/'.$post->image->slug)}}" id="imagePost"
                                        ...
                                        <div class="img_upload">
                                            ...
                                            <label class="label">
                                                ...
                                                <figure class="post-figure">
                                                    ...
                                                    <img id="imgPost" src={{asset('/storage/avatar/fundo.png')}}
                                                        alt="Escolha_uma_imagem" title="Escolha uma imagem" />
                        ...
                        <div class="container shadow-sm respostas">
                            ...
                            <div class="input-group resposta col-md-12 d-flex justify-content-md-center">
                                <input class="form-control" id="reply" name="reply"
                                    value="{{!empty($replier->id)?  $replier->pivot->reply:''}}" disabled>
                            </div>
                            @empty

                            <textarea class="form-control" placeholder="Nao tem respostas ainda!" readonly></textarea>
                    ...
                    <div class="container">
                        <!--Delete section-->
                        <form method="post" id="delete-form-{{$post->id}}" action="{{ route('posts', $post->id)}}"
                            style="display:none;">
                            @csrf
                            @method('DELETE')
                        </form>
            ...
            <div class="row col-md-12>">
                ...
                <div class="col-md-6 btn-group btn-group-lg">
                    <button type="button" onclick="window.location.href='/'" class="btn btn-secondary btn-lg ">Voltar
                    </button>
                </div>
                <div class="col-md-3">
                </div>
