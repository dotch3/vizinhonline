            ...
            <header class="header">
                <nav>
                    <ul class="nav">
                        ...
                        <li class="nav-item col-3"><button class="buttonHeader" data-toggle="modal"
                                data-target="#login">Entrar</button></li>
                    </ul>
                </nav>
            </header>
        </div>
                        ...
                        <div class="modal-body">
                            <form>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-5">
                                        <button type="button"
                                            class="btn btn-secondary btn-lg btn-block">Cadastre-se</button>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-2">
