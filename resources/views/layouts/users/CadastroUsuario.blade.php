                ...
                <div class="col-md-8">
                    <div class="profile-head col-10 text-center">
                        ...
                        <div class="row">  
                            ...
                            <div class = "col-5"> 
                                <input type="text" name="cpf" maxlength="14" placeholder="CPF" value="" required onkeydown="javascript: fMasc( this, mCPF ); ">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class = "col-5"> 
                                <input type="email_verified" name="email" placeholder="Confirmar E-mail" value="" required>
                            </div>
                        </div>
                        <br/>
                        <div class="row">
                            <div class="col-5">
                                <input type="text" name="cellphone" maxlength="17" placeholder="Celular" value="" onkeydown="javascript: fMasc( this, mTel );" required>
                            </div> 
                            <div class="col-5">  
                        ...
                        <div class="row">
                            ...
                            <div class="col-5">   
                                <input type="text" name="apartment_number" placeholder="Nro Apto" value="" required>  <!-- Relation with locations come here -->
                            </div>    
                        </div>
                        <br/>
                        <div class="row">
                        ...
                        <br>
                        <div>
                            <button type="button" class="btn btn-secondary" onclick="window.history.go(-1); return false;">Cancelar</button>
